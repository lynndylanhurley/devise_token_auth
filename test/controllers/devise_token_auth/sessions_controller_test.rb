...
class DeviseTokenAuth::SessionsControllerTest < ActionController::TestCase
  describe DeviseTokenAuth::SessionsController do
    describe "Confirmed user with username" do
      before do
        @existing_user = users(:confirmed_email_user_with_username)
      ...
      describe 'success' do
        ...
        test "request should return user data" do
          assert_equal @existing_user.username, @data['data']['username']
        end
      ...
      describe 'case-insensitive username' do
        ...
        test "request should succeed if configured" do
          @resource_class.case_insensitive_keys = [:username]
