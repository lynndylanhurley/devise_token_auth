    ...
    describe describe_orm_txt do
      describe DeviseTokenAuth::RegistrationsController do
        ...
        describe "Existing users" do
          before do
            @existing_user = get_confirmed_email_user_obj test_mongoid
            post "/#{auth_url}", {
        ...
        describe "Destroy user account" do
          describe "success" do
            ...
            test "existing user should be deleted" do
              refute user_class.where(id: @existing_user.id).first
            end
          end
          ...
          describe "existing user" do
            ...
            describe "without password check" do
              describe "success" do
                ...
                teardown do
                  # Need to clean the mongodb database
                  if test_mongoid
                    MongoidUser.or({email: @email}, {email: @email.downcase}).destroy
                  end
                end
        ...
        describe "Oauth user has existing email" do
          before do
            if test_mongoid
              @existing_user = create(:mongoid_user, :facebook)
            else
        ...
        describe "Alternate user class" do
          ...
          test "use should be a Mang" do
            if test_mongoid
              assert_equal "MongoidMang", @resource.class.name
            else
          ...
          test "Mang should be destroyed" do
            ...
            xhr :delete,  "/#{mang_auth_url}", {}, @auth_headers
        ...
        describe "Skipped confirmation" do
          setup do
            user_class.set_callback(:create, :before, :skip_confirmation!)
          ...
          teardown do
            user_class.skip_callback(:create, :before, :skip_confirmation!)
          end
